 ...
 * @ingroup Skins
 */
class Skinnsglossary extends SkinTemplate {
	/** Using roundedsassy. */
	function initPage( OutputPage $out ) {
		parent::initPage( $out );
		$this->skinname  = 'nsglossary';
		$this->stylename = 'nsglossary';
		$this->template  = 'NsglossaryTemplate';
	...
	function setupSkinUserCss( OutputPage $out ) {
		...
		$out->addStyle( 'nsglossary/main.css', 'screen' );
		if( $wgHandheldStyle ) {
			// Currently in testing... try 'chick/main.css'
			$out->addStyle( $wgHandheldStyle, 'handheld' );
		}

		$out->addStyle( 'nsglossary/IE50Fixes.css', 'screen', 'lt IE 5.5000' );
		$out->addStyle( 'nsglossary/IE55Fixes.css', 'screen', 'IE 5.5000' );
		$out->addStyle( 'nsglossary/IE60Fixes.css', 'screen', 'IE 6' );
		$out->addStyle( 'nsglossary/IE70Fixes.css', 'screen', 'IE 7' );
		$out->addStyle( 'nsglossary/IE80Fixes.css', 'screen', 'IE 8' );

		$out->addStyle( 'nsglossary/rtl.css', 'screen', '', 'rtl' );
	}
}
 ...
 * @ingroup Skins
 */
class NsglossaryTemplate extends QuickTemplate {
	var $skin;
	/**
...
<?php if($this->data['body_onload']) { ?> onload="<?php $this->text('body_onload') ?>"<?php } ?>
 class="mediawiki <?php $this->text('dir') ?> <?php $this->text('pageclass') ?> <?php $this->text('skinnameclass') ?>">
    ...
    <div id="access" role="navigation">
        ...
        <?php unset($this->data['sidebar']['MENUBAR']); ?>
			</div><!-- header menu -->
     <div class="visualClear"></div> 
  	</div>
...
?>
	...
	<div id="content">
	  <div id="right-navigation">
				<?php  $this->renderNavigation( $this->data['content_actions']); ?>
			</div>
    ...
    <div class="visualClear"></div>
    <div id="td-roundedbox" class="footer-container">
<div class="td-fbody">
...
?>
	<div id="p-search" class="portlet">
		<div id="searchBody" class="pBody">
          ...
          <input id="mw-searchButton" class="searchButton" type="submit" title="Search the pages for this text" value="Glossary search" name="fulltext">
        <!--<input type='submit' name="go" class="searchButton" id="searchGoButton"	value="<?php $this->msg('searcharticle') ?>" src="<?php print $wgScriptPath; ?>/skins/roundedsassy/go.gif" <?php echo $this->skin->tooltipAndAccesskeyAttribs( 'search-go' ); ?> /><?php if ($wgUseTwoButtonsSearchForm) { ?>&nbsp;
				<input type='submit' name="fulltext" class="searchButton" id="mw-searchButton" value="<?php $this->msg('searchbutton') ?>" src="<?php print $wgScriptPath; ?>/skins/roundedsassy/search.gif" <?php echo $this->skin->tooltipAndAccesskeyAttribs( 'search-fulltext' ); ?> /><?php } else { ?>
...
<?php
	...
	protected function renderNavigation( $elements ) {
		...
		// Render elements
	?>	
  <div id="actions-tab" style="margin:10px;">
	  <div class="menu">
		  <ul<?php $this->html( 'userlangattributes' ) ?>>
			  <?php foreach ( $elements as $link ): ?>
